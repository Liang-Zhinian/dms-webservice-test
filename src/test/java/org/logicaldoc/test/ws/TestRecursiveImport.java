...
public class TestRecursiveImport extends BaseTestCase {

	protected static Log log = LogFactory.getLog(TestRecursiveImport.class);
	...
	public TestRecursiveImport(String arg0) {
		super(arg0);
	}
