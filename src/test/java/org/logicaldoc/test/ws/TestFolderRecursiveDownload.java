...
public class TestFolderRecursiveDownload extends BaseTestCase  {

	protected static Log log = LogFactory.getLog(TestFolderRecursiveDownload.class);

	public TestFolderRecursiveDownload(String arg0) {
		super(arg0);
	}	
