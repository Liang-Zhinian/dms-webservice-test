...
public class TestMassiveImport extends BaseTestCase{

	private static final int TIME_ATTENTION_TRESHOLD = 30000;

	private static final int MAX_DOCUMENTS_TOBE_INSERTED = 15000;

	protected static Log log = LogFactory.getLog(TestMassiveImport.class);
	...
	public TestMassiveImport(String arg0) {
		super(arg0);
	}
