...
public class TestDocumentCRUD extends BaseTestCase {
	
	protected static Log log = LogFactory.getLog(TestDocumentCRUD.class);
	
	public TestDocumentCRUD(String arg0) {
		super(arg0);
	}
