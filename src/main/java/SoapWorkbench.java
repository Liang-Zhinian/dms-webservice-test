...
public class SoapWorkbench {
	...
	public static void main(String[] args) throws Exception {
		...
		String base = "http://isd4u.com:8080/services";
	...
	private static void foldersAndDocuments02(SoapDocumentClient documentClient, SoapFolderClient folderClient, String sid)
		...
		//File file = new File("/C:/Users/Matteo/Desktop/doctest/signdoc_en.pdf");
		...
		for (WSDocument wsDocument : docs) {
			...
			System.out.println("doc title: " + wsDocument.getFileName());
		}
		...
		System.out.println("doc title: " + wsDoc.getFileName());
		...
		System.out.println("doc title: " + doc.getFileName());
		System.out.println("doc customid: " + doc.getCustomId());

		documentClient.sendEmail("ciccio", new Long[] { 690L, 32L, 29L }, "m.caruso@logicalobjects.it",
				"Test Invio Mail 2", "Questa mail � un test");
...
//			}
	...
	private static void searchFeatures(SoapSearchClient searchClient, String sid) throws Exception {
		...
		for (WSDocument hit : result.getHits()) {
			...
			System.out.println("hit title: " + hit.getFileName());
	...
	private static void foldersAndDocuments01(SoapDocumentClient documentClient, SoapFolderClient folderClient, String sid)
			throws Exception {
	...
	private static void usersAndGroupsManagement(SoapSecurityClient securityClient, String sid) throws Exception {
		...
		WSUser[] users2 = securityClient.listUsers(sid);
